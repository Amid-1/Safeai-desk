...
> Документ описывает фактически реализованную архитектуру текущих backend/frontend исходников и Flyway-миграций до `V44`. Будущее развитие вынесено в [`ROADMAP.md`](ROADMAP.md).

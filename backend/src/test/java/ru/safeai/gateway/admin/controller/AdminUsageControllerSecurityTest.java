...
@Import({
        ...
        AdminUsageControllerSecurityTest.TestClockConfig.class,
...
class AdminUsageControllerSecurityTest {
    ...
    @Test
    void userEndpointUsesRestStylePath()
            throws Exception {
        SafeAiUserPrincipal principal =
                adminPrincipal();
    ...
    @Test
    void organizationEndpointUsesRestStylePath()
            throws Exception {
        SafeAiUserPrincipal principal =
                adminPrincipal();
        ...
        mockMvc.perform(
                        get(
                                "/api/admin/usage/organizations/{organizationId}",
                                ORGANIZATION_ID
                        )
                                .with(
                                        authentication(

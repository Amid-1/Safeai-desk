...
public class KnowledgeRetrievalRepository {
    ...
    public KnowledgeRetrievalRepository(
    ...
    public List<KnowledgeRetrievalHit> hybridSearch(
        ...
        return jdbc.query(
                ...
                allowed_chunks as not materialized (
                    select
                    ...
                    join knowledge_bases knowledge_base
                     ...
                     and knowledge_base.organization_id =

...
export function parseRuntimeModelStatus(
    ...
    return {
        ...
        routingMode: expectEnum(
            record.routingMode,
            `${field}.routingMode`,
            ROUTING_MODES,
        ),
        maxInputTokens: expectNonNegativeInteger(
            record.maxInputTokens,
            `${field}.maxInputTokens`,
        ),
        maxOutputTokens: expectNonNegativeInteger(
            record.maxOutputTokens,
            `${field}.maxOutputTokens`,
        ),
        toolsSupported: expectBoolean(
            record.toolsSupported,
            `${field}.toolsSupported`,
        ),
        visionSupported: expectBoolean(
            record.visionSupported,
            `${field}.visionSupported`,
        ),
        structuredOutputSupported: expectBoolean(
            record.structuredOutputSupported,
            `${field}.structuredOutputSupported`,
        ),
        dataRetentionStatus: expectEnum(
            record.dataRetentionStatus,
            `${field}.dataRetentionStatus`,
            RUNTIME_RETENTION_STATUSES,
        ),
        healthStatus: expectEnum(
            record.healthStatus,
            `${field}.healthStatus`,
            HEALTH_STATUSES,
        ),
        pricingStatus: expectEnum(
            record.pricingStatus,
            `${field}.pricingStatus`,
            RUNTIME_PRICING_STATUSES,
        ),
        inputUsdPer1mTokens: parseDecimalString(
            wireNullable(record.inputUsdPer1mTokens),
            `${field}.inputUsdPer1mTokens`,
        ),
        outputUsdPer1mTokens: parseDecimalString(
            wireNullable(record.outputUsdPer1mTokens),
            `${field}.outputUsdPer1mTokens`,
        ),
        pricingVersion:
            expectNullableString(
                wireNullable(record.pricingVersion),
...
export function parseModelCatalogEntry(
    ...
    return {
        ...
        retentionStatus: expectEnum(
            record.retentionStatus,
            `${field}.retentionStatus`,
            MODEL_RETENTION_STATUSES,
        ),
        retentionDays: expectNullableNonNegativeInteger(
            wireNullable(record.retentionDays),
            `${field}.retentionDays`,
        ),
        trainingUseStatus: expectEnum(
            record.trainingUseStatus,
            `${field}.trainingUseStatus`,
        ...
        cachedInputUsdPer1mTokens: parseDecimalString(
            wireNullable(record.cachedInputUsdPer1mTokens),
            `${field}.cachedInputUsdPer1mTokens`,
        ),
        cacheWriteInputUsdPer1mTokens: parseDecimalString(
            wireNullable(record.cacheWriteInputUsdPer1mTokens),
            `${field}.cacheWriteInputUsdPer1mTokens`,
        ),
        outputUsdPer1mTokens: parseDecimalString(
            wireNullable(record.outputUsdPer1mTokens),
            `${field}.outputUsdPer1mTokens`,
        ),
        extraPricingJson: expectString(
            record.extraPricingJson,
            `${field}.extraPricingJson`,
            {
                allowEmpty: false,
                maxLength: 16_000,
            },
...
export function parseOrganizationModelPolicy(
    ...
    return {
        configured: expectBoolean(
            record.configured,
            `${field}.configured`,
        ),
        id: expectNullableUuid(
            wireNullable(record.id),
            `${field}.id`,
        ),
        ...
        allowModelKeys: parseModelKeyArray(
            record.allowModelKeys,
            `${field}.allowModelKeys`,
        ),
        denyModelKeys: parseModelKeyArray(
            record.denyModelKeys,
            `${field}.denyModelKeys`,
        ),
        defaultModelKey: expectNullableString(
            wireNullable(record.defaultModelKey),
            `${field}.defaultModelKey`,
            {maxLength: 160},
        ),
        maxInputTokens: expectNullableNonNegativeInteger(
            wireNullable(record.maxInputTokens),
            `${field}.maxInputTokens`,
        ),
        maxOutputTokens: expectNullableNonNegativeInteger(
            wireNullable(record.maxOutputTokens),
            `${field}.maxOutputTokens`,
        ),
        maxRequestCostUsd: parseDecimalString(
            wireNullable(record.maxRequestCostUsd),
            `${field}.maxRequestCostUsd`,
        ),
        monthlyBudgetUsd: parseDecimalString(
            wireNullable(record.monthlyBudgetUsd),
            `${field}.monthlyBudgetUsd`,
        ),
        budgetEnforcement: expectEnum(
            record.budgetEnforcement,
            `${field}.budgetEnforcement`,
            BUDGET_ENFORCEMENTS,
        ),
        requireCompletePricing: expectBoolean(
            record.requireCompletePricing,
            `${field}.requireCompletePricing`,
        ),
        requireNoTraining: expectBoolean(
            record.requireNoTraining,
            `${field}.requireNoTraining`,
        ),
        requireZeroDataRetention: expectBoolean(
            record.requireZeroDataRetention,
            `${field}.requireZeroDataRetention`,
        ),
        createdByUserId: expectNullableUuid(
            wireNullable(record.createdByUserId),
            `${field}.createdByUserId`,
        ),
        createdAt: expectNullableInstant(
            wireNullable(record.createdAt),
            `${field}.createdAt`,
        ),
    }
}
...
export function parseModelRouteDecision(
    ...
    return {
        ...
        chatTurnId: expectNullableUuid(
            wireNullable(record.chatTurnId),
            `${field}.chatTurnId`,
        ),
        ...
        requestContentHash: expectSha256(
            record.requestContentHash,
            `${field}.requestContentHash`,
        ),
        requestedModelKey: expectNullableString(
            wireNullable(record.requestedModelKey),
            `${field}.requestedModelKey`,
            {maxLength: 160},
        ),
        selectedCatalogEntryId: expectNullableUuid(
            wireNullable(record.selectedCatalogEntryId),
            `${field}.selectedCatalogEntryId`,
        ),
        selectedCatalogVersion:
            expectNullableNonNegativeInteger(
                wireNullable(record.selectedCatalogVersion),
                `${field}.selectedCatalogVersion`,
            ),
        selectedModelKey: expectNullableString(
            wireNullable(record.selectedModelKey),
            `${field}.selectedModelKey`,
            {maxLength: 160},
        ),
        selectedProvider: expectNullableString(
            wireNullable(record.selectedProvider),
            `${field}.selectedProvider`,
            {maxLength: 32},
        ),
        selectedProviderModelId: expectNullableString(
            wireNullable(record.selectedProviderModelId),
            `${field}.selectedProviderModelId`,
            {maxLength: 100},
        ),
        policyId: expectNullableUuid(
            wireNullable(record.policyId),
            `${field}.policyId`,
        ),
        policyVersion: expectNullableNonNegativeInteger(
            wireNullable(record.policyVersion),
            `${field}.policyVersion`,
        ),
        requiredCapabilities: expectStringArray(
        ...
        estimatedInputTokens:
            expectNullableNonNegativeInteger(
                wireNullable(record.estimatedInputTokens),
                `${field}.estimatedInputTokens`,
            ),
        estimatedOutputTokens:
            expectNullableNonNegativeInteger(
                wireNullable(record.estimatedOutputTokens),
                `${field}.estimatedOutputTokens`,
            ),
        estimatedMaxCostUsd: parseDecimalString(
            wireNullable(record.estimatedMaxCostUsd),
            `${field}.estimatedMaxCostUsd`,
        ),
        monthlyBudgetUsd: parseDecimalString(
            wireNullable(record.monthlyBudgetUsd),
            `${field}.monthlyBudgetUsd`,
        ),
        monthlySpentUsd: parseDecimalString(
            wireNullable(record.monthlySpentUsd),
            `${field}.monthlySpentUsd`,
        ),
        monthlyProjectedUsd: parseDecimalString(
            wireNullable(record.monthlyProjectedUsd),
            `${field}.monthlyProjectedUsd`,
        ),
        monthlyCostKnown: expectBoolean(
            record.monthlyCostKnown,
            `${field}.monthlyCostKnown`,
        ),
        budgetEnforcement: expectNullableEnum(
            wireNullable(record.budgetEnforcement),
            `${field}.budgetEnforcement`,
            BUDGET_ENFORCEMENTS,
        ),
        budgetExceeded: expectBoolean(
            record.budgetExceeded,
            `${field}.budgetExceeded`,
        ),
        pricingComplete: expectBoolean(
            record.pricingComplete,
            `${field}.pricingComplete`,
        ...
        decisionSha256: expectSha256(
            record.decisionSha256,
            `${field}.decisionSha256`,
        ),
        createdAt: expectInstant(
            record.createdAt,
            `${field}.createdAt`,
...
/**
 * Backend globally serializes JSON with Jackson NON_NULL.
 *
 * A Java DTO field whose domain value is null is therefore absent from the
 * wire object rather than encoded as an explicit JSON null. Frontend domain
 * models keep nullable fields normalized to null so UI code has one stable
 * representation.
 *
 * This helper is intentionally used only for fields whose backend DTO contract
 * is nullable. Required fields still fail closed when they are omitted.
 */
function wireNullable(
    value: unknown,
): unknown {
...
function expectSha256(
    ...
    if (!/^[0-9a-f]{64}$/.test(hash)) {
        throw contractError(
            `${field} должен быть lowercase SHA-256`,
        )
    }
